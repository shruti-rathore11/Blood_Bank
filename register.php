...
<div class="w3-row w3-section">
  <div class="w3-col" style="width:50px"><i class="w3-xxlarge fa fa-tint"></i></div>
    <div class="w3-rest">
      <input class="w3-input w3-border" name="bg" type="text" placeholder="Blood Group" required>
    </div>
</div>
...
<div class="w3-row w3-section">
  <div class="w3-col" style="width:50px"><i class="w3-xxlarge fa fa-map-marker"></i></div>
    <div class="w3-rest">
      <input class="w3-input w3-border" name="p" type="text" placeholder="Pincode">
    </div>
</div>
...
<div class="w3-row w3-section">
  <div class="w3-col" style="width:50px"><i class="w3-xxlarge fa fa-user-secret"></i></div>
    <div class="w3-rest">
      <input class="w3-input w3-border" name="user" type="text" placeholder="User Name" required>
    </div>
</div>
...
<div class="w3-row w3-section">
  <div class="w3-col" style="width:50px"><i class="w3-xxlarge fa fa-lock"></i></div>
    <div class="w3-rest">
      <input class="w3-input w3-border" name="pass" type="text" placeholder="Password" required>
    </div>
</div>
...
<?php
		if(isset($_REQUEST['first']))
	{
       ...
       $q1="Select * from donor where user = '$user'";
       ...
       {
       $q="Insert into donor values('$f','$l','$e','$p','$dob','$bg','$w','$s','$c','$a','$user','$pass')";
